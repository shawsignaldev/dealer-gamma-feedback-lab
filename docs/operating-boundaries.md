...
dealer positioning is inferred, not directly observed, and feedback effects can vary by expiration, index weight, and liquidity. A serious reviewer should see that this risk is named directly rather than hidden behind
