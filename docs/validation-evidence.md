...
themes are: absolute gain calculation, threshold labeling, small-shock fixtures, and stress-gain examples. These checks are deliberately modest, but they establish a baseline that
